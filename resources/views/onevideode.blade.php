...
@endif
    ...
    <script>
        ...
        $('.video2').click(function(){
            ...
            window.history.pushState("object or string", "Title", "/onvideode/"+category+"/"+video_id);
               @else
            var category = '{{Request::segment(1)}}';
            window.history.pushState("object or string", "Title", "/onvideode/"+video_id);
           @endif
            $('#player').show();
            $('#video1').hide();
            document.getElementById("video1").src = '';
        ...
        function playme(filename) {
            ...
            window.history.pushState("object or string", "Title", "/onvideode/"+category+"/"+filename);
            @else
            var category = '{{Request::segment(1)}}';

            window.history.pushState("object or string", "Title", "/onvideode/"+filename);
            @endif
            $('#player').hide();
            $('#video1').show();
        ...
        $( ".chosen-select").on('change',function(e)
        {
            ...
            var urla = "{{url('onvideode')}}/" + cat_name+ "" ;
            window.location.href = urla;
