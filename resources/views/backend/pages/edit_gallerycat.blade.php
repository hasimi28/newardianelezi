                ...
                <div class="row">
                    <div class="col-lg-6 col-md-offset-2">
                        <div class="well bs-component">
                            <form class="form-horizontal" id="forma" action="{{route('gallerycat.update',$cat->id)}}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control" name="name_sq" id="name" type="text" value="{{$cat->name_sq}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control" name="name_de" id="email" type="text" value="{{$cat->name_de}}">
                                        </div>
                                    </div>
