    ...
    <div class="page-title">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>Forms</li>
                <li><a href="#">Shto Video Kategori Gjermanisht</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-offset-2">
                        <div class="well bs-component">
                            ...
                            @endif
                            <form class="form-horizontal"  action="{{route('categorymanagerde.store')}}" method="POST">
                                {{ csrf_field() }}

                                <fieldset>
                                    <legend>Shto Video Kategori Gjermanisht</legend>
