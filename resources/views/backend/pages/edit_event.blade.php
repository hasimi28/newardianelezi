                ...
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        ...
                        <div class="well bs-component">
                            <form class="form-horizontal" id="demo-form" action="{{route('event.update',$ev->id)}}" method="POST" data-parsley-validate enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control" name="title_sq" id="title_sq" type="text" value="{{$ev->ti_sq}}" required=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control" name="title_de" id="title_de" type="text" value="{{$ev->ti_de}}"  required=""
                                                   data-parsley-required-message="@lang('app_lang.parsley_required')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="textArea" name="text_sq" rows="3"
                                                      data-parsley-required-message="@lang('app_lang.parsley_required')"> {!! $ev->des_sq !!}</textarea><span class="help-block"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="textArea" name="text_de" rows="3"
                                                      data-parsley-required-message="@lang('app_lang.parsley_required')"> {!! $ev->des_de !!}</textarea><span class="help-block"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class="form-control" name="adress" id="title_de" type="text" value="{!! $ev->adress !!}"  required=""
                                                   data-parsley-required-message="@lang('app_lang.parsley_required')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="file" name="image" id="profile-img" class="btn btn-primary btn-file"> <img src="{{asset('postimages/'.$ev->image)}}" id="profile-img-tag" width="200px" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <div class='input-group date' id='datetimepicker1'>
                                                <input type='text' name="datetime" class="form-control" value="{{$ev->datetime}}"/>
