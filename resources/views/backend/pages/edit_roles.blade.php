...
@section('content')
    <div class="page-title">
        <div>
            <h1><i class="fa fa-archive"></i> Edit {{$roles->display_name}} </h1>
    ...
    <div class="row" style="background:white;">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input class="form-control" name="display_name" id="display_name" type="text" value="{{$roles->name}}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <input class="form-control" name="name" id="email" type="text" value="{{$roles->display_name}}" disabled>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg-2 control-label" for="inputPassword">Description</label>
            <div class="col-lg-10" >
                <input type="text" class="form-control" id="desc"  name="description" value="{{$roles->description}}">
                <br>
